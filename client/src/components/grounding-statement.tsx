...
export function GroundingStatement({ compact = false }: GroundingStatementProps) {
  if (compact) {
    return (
      <div className="rounded-xl border border-forest/30 bg-forest/5 p-4" data-testid="grounding-compact">
  ...
  return (
    <div className="rounded-2xl border border-forest/30 bg-forest/5 p-5" data-testid="grounding-full">
